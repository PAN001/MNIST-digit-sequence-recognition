...
# model-5
python main.py --cuda --epoch 1000 --lr 0.01 --log-interval 1 --id 2scnn_2bilstm_scaled_100 --batch-size 16 --model-path model_2scnn_2bilstm_scaled_100_best_model.pt 