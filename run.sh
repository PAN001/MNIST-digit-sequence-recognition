...
# model-6
python main.py --cuda --lr 0.01 --batch-size 32 --epoch 1000 --log-interval 1 --id 2scnn_2bilstm_scaled_100_random_new --model-path 2scnn_2bilstm_scaled_100_random_retrained_best_model.pt --eval
