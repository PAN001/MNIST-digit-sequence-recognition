...
# model-6
python main.py --cuda --lr 0.02 --batch-size 16 --epoch 1000 --log-interval 1 --model-path 2scnn_2bilstm_scaled_100_best_model.pt --id 2scnn_2bilstm_scaled_100_random_retrained
